...
public interface CheckpointListener {
    ...
    void onScroll(@ScrollableBehaviorController.EdgeFlag int edgeFlag, int currentOffset, int offsetDelta, Checkpoint front, Checkpoint back, @ViewCompat.NestedScrollType int type);
