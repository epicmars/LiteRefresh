...
public interface OnScrollListener {
     ...
     * @param initial the initial offset of the child view
     * @param trigger the trigger offset of the child view related to the refreshing state changing
     * @param min     the minimum offset of the child view, the child can not scroll out of the range
     *                limited by minimum and maximum offset
     * @param max     the maximum offset of the child view, the child can not scroll out of the range
     *                limited by minimum and maximum offset
     * @param type    the type of touch event that cause the scrolling to happen
     */
    void onStartScroll(CoordinatorLayout parent, View child, int initial, int trigger, int min, int max, int type);
     ...
     * @param type    the type of touch event that cause the scrolling to happen
     */
    void onPreScroll(@NonNull CoordinatorLayout parent, @NonNull View view, int current, int initial, int trigger, int min, int max, int type);
